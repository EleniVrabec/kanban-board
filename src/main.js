...
document.addEventListener('DOMContentLoaded', () => {
    ...
    async function displayNotes() {
        ...
        querySnapshot.forEach((doc) => {
            ...
            li.addEventListener('grag', handleDragStart)
    ...
    function handleDragEnd(event) {
        ...
        const draggedElement = document.getElementById(event.target.dataset.id)
        console.log(draggedElement)
        console.log(currentOverColumn);

       if(currentOverColumn!=null) currentOverColumn.appendChild(draggedElement)
...
/*       column.addEventListener('mouseover' , (e)=>{
       ...
       column.addEventListener('dragover', (event) => {
            ...
            console.log(column)
            currentOverColumn = document.getElementById(column.id)
